<?php
    ...
    for ($i = 0; $i < $num_rows; $i++){
        ...
        $post_obj = new post($row['user'],$row['category'],$row['description'], $row['title'], $row['date'], $row['votes'], $row['comments'], $row['id']);
...
BODY;
    ...
    if ($noData){
        $page .= "No posts have been created. Be the first!";
    }
